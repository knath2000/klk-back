...
export declare abstract class BaseLLMAdapter implements ILLMAdapter {
    ...
    abstract streamCompletion(messages: LLMMessage[], options: LLMOptions): AsyncIterable<DeltaChunk>;
    abstract fetchCompletion(messages: LLMMessage[], options: LLMOptions): Promise<string>;
